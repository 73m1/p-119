...
document.getElementById(sketchName).innerHTML = " Sketch to be drawn: " + random_sketch
...
if (error) {
    ...
    document.getElementById("sketchName").innerHTML = "Sketch to be drawn: " + drawn_sketch;
